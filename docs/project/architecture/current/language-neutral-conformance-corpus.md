...
per-case `review-report.json` is local reviewer evidence and is not committed, because
it snapshots one import run and cannot be refreshed without regenerating every golden.
