...
a display block. Dollar-shaped prose must remain byte-safe even when the
preservation-biased recognizer conservatively treats a balanced pair as atomic. Reflowing
surrounding prose is expected.
